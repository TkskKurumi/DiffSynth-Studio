...
def add_training_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--warmup-steps", type=int, default=0, help="Number of linear warmup steps for lr-scheduler. Default: 0.")
    parser.add_argument("--restart-steps", type=int, default=1000, help="Number of steps per cosine cycle for cosine-warmup-restart scheduler. Default: 1000.")
    parser.add_argument("--edecay-steps", type=int, default=10000, help="Exponential decay time constant for cosine-warmup-restart scheduler. Default: 10000.")
